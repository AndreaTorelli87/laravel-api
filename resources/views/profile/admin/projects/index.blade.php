            ...
            <div class="flip-card-inner position-relative overflow-y-hidden">
               ...
               <div class="flip-card-back position-absolute text-center p-2 bg-white">
                  <div class="d-flex justify-content-around mb-2">
                     <a class="btn btn-success me-2" href="{{route("admin.projects.show", ["project" => $project->id])}}"><i class="fa-solid fa-eye"></i></a>
                     <a class="btn btn-warning me-2" href="{{route("admin.projects.edit", ["project" => $project->id])}}"><i class="fa-solid fa-pen"></i></a>
